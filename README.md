...
- 🔭 I’m currently working as a Data Scientist, trying to solve real world business problems across domains using Machine Learning, Deep Learning, Computer Vision, Neural Networks, Image Processing, Convolutional Neural Networks (CNN), Recurrent Neural Networks (RNN), Classification, Regression, Clustering, Bagging, Boosting, Object Detection, Semantic Segmentation.
